...
const darkModeStylesDir = path.join(__dirname, '..', '..', '..','app.asar.unpacked', 'src', 'static')

const darkModeStyles = path.join(darkModeStylesDir, 'dark.css')

window.initDarkModeAlt = () => {
  const currDirContents = readdir(darkModeStylesDir, (err, files) => {
    if (err) console.error(err)
    
    console.log(`\n\n---------\nSTYLES DIR is `, darkModeStylesDir, '\n-----------------\n')
    
    console.log(`\n\n------------\nDIR CONTENTS ARE `, files, '\n-----------------\n\n')
  })
