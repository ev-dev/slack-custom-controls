...
window.initDefaultMode = () => {
  ...
  // $('<style>.p-message_pane .c-message_list:not(.c-virtual_list--scrollbar):before, .p-message_pane .c-message_list.c-virtual_list--scrollbar > .c-scrollbar__hider:before{background-color: #fff;}</style>')
  //   .appendTo('head')
...
document.addEventListener('DOMContentLoaded', () => {
  setTimeout(() => {
    if (window.darkModeEnabled) window.initDarkMode()
  }, 1500)
