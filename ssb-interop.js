...
window.setThemeDark = () => {
	...
	// $('.channel_header').css('background-color', '#261C25')
	// $('#channel_title').css('color', '#757575')
	// $('<style>.p-message_pane .c-message_list:not(.c-virtual_list--scrollbar):before, .p-message_pane .c-message_list.c-virtual_list--scrollbar > .c-scrollbar__hider:before{background-color: #121212;}</style>')
	// 	.appendTo('head')
